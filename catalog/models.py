...
# Used to assign loan books to users
...
class Language(models.Model):
    ...
    """
    name = models.CharField(max_length=200, 
        help_text="Enter a book's natural language (e.g. Englis, French, Japanese, etc)")
...
class Author(models.Model):
    ...
    def get_absolute_url(self):
        """
        Returns the rul to access a particular author instance.
        """
        return reverse('author-detail', args=[str(self.id)])
    
    def __str__(self):
        """
        String for representing the Model Object.max
        """
